    ...
    public class TestCacheDelegatingHandlerBaseTests
    {
        ...
        internal static IEnumerable<object[]> GetPathsAndTestUris =>
            new List<object[]>
            {
                ...
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\Airports", "$filter=contains(LocationAddress,_'San_Francisco')", "https://services.odata.org/TripPinRESTierService/Airports?$filter=contains(Location/Address, 'San Francisco')" },
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\Airports", "$select=Name,_IcaoCode", "https://services.odata.org/TripPinRESTierService/Airports?$select=Name, IcaoCode" },
                ...
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\Me\\Friends", "$filter=Friendsany(ffFirstName_eq_'Scott')", "https://services.odata.org/TripPinRESTierService/Me/Friends?$filter=Friends/any(f:f/FirstName eq 'Scott')" },
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\People\\('keithpinckney')", "$expand=Trips", "https://services.odata.org/TripPinRESTierService/People('keithpinckney')?$expand=Trips" },
                ...
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\People\\('russellwhyte')", "$expand=Trips($select=TripId,_Name)", "https://services.odata.org/TripPinRESTierService/People('russellwhyte')?$expand=Trips($select=TripId, Name)" },
                ...
                //new object[] { "application/json", "services.odata.org\\TripPinRESTierService\\GetNearestAirport\\(lat_=_33,_lon_=_-118)", "root", "https://services.odata.org/TripPinRESTierService/GetNearestAirport(lat = 33, lon = -118)" },
