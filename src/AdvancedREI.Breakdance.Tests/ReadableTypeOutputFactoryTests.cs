...
namespace AdvancedREI.Breakdance.Tests
{
    ...
    public class ReadableTypeOutputFactoryTests
    {
        ...
        public void ReadableTypeOutputFactory_GetEventInfo_SomeStaticClass()
        {
            ...
            eventString.Should().BeEquivalentTo("AdvancedREI.Breakdance.Tests.SampleApis.SomeStaticClass+SomeEventHandler SomeEvent { public static add; public static remove; }");
        }
        ...
        public void ReadableTypeOutputFactory_GetTypeDeclaration_StaticClass()
        {
            ReadableTypeOutputFactory.GetTypeDeclarationString(typeof(SomeStaticClass))
                ...
                .And.BeEquivalentTo("public sealed class AdvancedREI.Breakdance.Tests.SampleApis.SomeStaticClass");
        }
        ...
        public void ReadableTypeOutputFactory_GetTypeDeclaration_InheritedGenericClass()
        {
            ReadableTypeOutputFactory.GetTypeDeclarationString(typeof(SomeStringList))
                .Should().NotBeNullOrWhiteSpace()
                .And.BeEquivalentTo("public class AdvancedREI.Breakdance.Tests.SampleApis.SomeStringList : System.Collections.Generic.List`1<string>, ICollection, IEnumerable, " + 
        ...
        public void ReadableTypeOutputFactory_GetTypeDeclaration_GenericClass()
        {
            ReadableTypeOutputFactory.GetTypeDeclarationString(typeof(SomeGenericClass<string>))
                .Should().NotBeNullOrWhiteSpace()
                .And.BeEquivalentTo("public class AdvancedREI.Breakdance.Tests.SampleApis.SomeGenericClass`1<System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089>");
        }
