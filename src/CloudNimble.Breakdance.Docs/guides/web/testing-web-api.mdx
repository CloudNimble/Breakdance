---
title: "In-Memory Web API Testing"
description: "Learn how to write fast, reliable tests for ASP.NET Web API controllers without spinning up a real HTTP server."
---
...
<Steps>
  <Step title="Install the package">
    ...
    ```bash
    dotnet add package CloudNimble.Breakdance.WebApi
    ```
  </Step>
...
| SSL testing | No | Yes |
| Middleware | Some limitations | Full support |
...
<CardGroup cols={2}>
  ...
  <Card title=".http File Testing" icon="file-code" href="guides/web/dothttp-testing">
    Write tests using Visual Studio's .http file format
  </Card>
</CardGroup>
