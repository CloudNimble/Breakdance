...
icon: lock
tag: "SEALED"
keywords: ['TypeComparer', 'CloudNimble.Breakdance.Assemblies.TypeComparer', 'CloudNimble.Breakdance.Assemblies', 'class', 'System.Object', 'System.Collections.IComparer']
---
...
```csharp
CloudNimble.Breakdance.Assemblies.TypeComparer
```
