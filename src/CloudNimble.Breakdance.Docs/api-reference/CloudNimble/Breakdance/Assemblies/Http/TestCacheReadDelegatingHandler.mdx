...
keywords: ['TestCacheReadDelegatingHandler', 'CloudNimble.Breakdance.Assemblies.Http.TestCacheReadDelegatingHandler', 'CloudNimble.Breakdance.Assemblies.Http', 'class', 'CloudNimble.Breakdance.Assemblies.Http.TestCacheDelegatingHandlerBase']
---
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> ResponseFilesPath <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="thumbtack" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> GetFileExtensionString <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="thumbtack" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> GetPathInfo <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="thumbtack" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> GetResponseMediaTypeString <DocsBadge text="Inherited" variant="neutral" />
